...
| [`cookies`](enlace_auth.auth.cookies.md#module-enlace_auth.auth.cookies)           | Signed cookie helpers built on itsdangerous.                                        |
|----------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------|
| [`email`](enlace_auth.auth.email.md#module-enlace_auth.auth.email)               | Outbound email for enlace_auth — used by the password-recovery flow.                |
| [`grants`](enlace_auth.auth.grants.md#module-enlace_auth.auth.grants)             | Runtime per-app access grants, with optional UTC expiry.                            |
| [`middleware`](enlace_auth.auth.middleware.md#module-enlace_auth.auth.middleware)     | Platform auth middleware (pure ASGI).                                               |
| [`oauth`](enlace_auth.auth.oauth.md#module-enlace_auth.auth.oauth)               | OAuth2/OIDC login via Authlib.                                                      |
| [`oauth_server`](enlace_auth.auth.oauth_server.md#module-enlace_auth.auth.oauth_server) | OAuth 2.1 authorization server — issue tokens for MCP custom connectors.            |
| [`pages`](enlace_auth.auth.pages.md#module-enlace_auth.auth.pages)               | HTML pages for the enlace_auth browser-facing flows.                                |
| [`passwords`](enlace_auth.auth.passwords.md#module-enlace_auth.auth.passwords)       | Password hashing via argon2id.                                                      |
| [`reset_tokens`](enlace_auth.auth.reset_tokens.md#module-enlace_auth.auth.reset_tokens) | Password-reset tokens — minting, verification, and the link they live in.           |
